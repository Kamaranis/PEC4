...
Este módulo contiene funciones para calcular y analizar 
la duración de emisión de series de televisión. 
Proporciona funcionalidades para procesar datos de series, 
incluyendo la conversión de fechas de emisión a formatos 
de fecha de Python y el cálculo del número total de días 
que cada serie ha estado en emisión.

Funciones:
    calculo_dias_emision(df): Calcula el número de días de emisión 
    para cada serie en un DataFrame y dvuelve los 10 registros 
    con mayor tiempo de emisión.

Ejemplo de uso:
    df_modificado, top_10_series = \
        calculo_dias_emision(df_original)
"""
