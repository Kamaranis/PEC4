# filtrado_series.py
"""
Este módulo ofrece funcionalidades para filtrar series de 
televisión basadas en criterios específicos como el 
idioma original, palabras clave en el resumen, 
el año de inicio y el estado de producción. Estas 
funciones permiten analizar y extraer subconjuntos 
de datos relevantes para análisis posteriores o visualizaciones.

Funciones:
    filtrar_series_por_idioma_y_palabras: \
        Filtra series por el idioma original y la presencia de 
        palabras clave en el resumen.
    filtrar_series_2023_canceladas: \
        Identifica series que comenzaron en 2023 y han sido 
        canceladas.
    filtrar_series_japonesas: \
...
def filtrar_series_por_idioma_y_palabras(df, idioma, palabras):
    """
    Filtra y muestra los nombres de las series cuyo idioma original 
    sea el especificado y cuyo resumen contenga alguna de 
    las palabras dadas.
    ...
    Args:
        ...
        idioma (str): \
            Idioma original de las series a filtrar.
        palabras (list): \
            Lista de palabras a buscar en el resumen.
...
def filtrar_series_2023_canceladas(df, year='2023', status='canceled'):
    """
    Filtra y devuelve los nombres de las series que comenzaron 
    en el año especificado y han sido canceladas.
    En este caso asibamos el valor por defecto de 'status' a 
    'canceled' y especificamos el valor por defecto 
    de 'year' a '2023'.
    ...
    Returns:
        pd.Series: Serie de pandas con los nombres de las series que 
        cumplen los criterios.
    """
...
def filtrar_series_japonesas(df):
    """
    Filtra y devuelve un DataFrame con los nombres, 
    nombres originales, plataformas de emisión y 
    empresas productoras de todas las series que 
    incluyan el idioma japonés.

    Args:
        df (pd.DataFrame): DataFrame que contiene 
